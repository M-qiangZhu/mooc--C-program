...
<img src="https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200506234717.png?Lingting_Gun" style="zoom:85%;" />
...
![image-20200323181412648](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013142.png?Lingting_Gun)

**找到字符并将该字符以及该字符以后的东西复制到另一个字符串中去**

![image-20200323182027826](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013147.png?Lingting_Gun)

**输出所找字符前面的字符串，不包括该字符**

![image-20200323182337053](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013154.png?Lingting_Gun)
...
![image-20200324163928678](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013206.png?Lingting_Gun)
...
![image-20200325171351300](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013231.png?Lingting_Gun)
...
- 静态本地变量的初始化***只会在第一次进入***这个函数时做，以后进入函数会保持上次离开时的值
    ...
    ![image-20200325180255593](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013238.png?Lingting_Gun)

- 静态本地变量实际上是特殊的全局变量

- 它们位于相同的内存区域

    ![image-20200325181457617](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013243.png?Lingting_Gun)
...
- **#define用来定义一个宏**
    ...
    ![image-20200325220301532](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013252.png?Lingting_Gun)

    - `gcc --save-temps main.c`会保留编译过程当中的临时文件

    - `.c`经过编译预处理，产生一个中间结果文件`.i`

        ![image-20200325220906836](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013257.png?Lingting_Gun)
...
- 它会把头文件的全部内容原封不动的插入到它所在的地方
    ...
    - 所以也不一定要在.c文件的最前面`#include`
        ...
        ![image-20200327165326676](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013313.png?Lingting_Gun)

        - `gcc`可以同时编译多个`.c`文件

        ![image-20200327165440607](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013319.png?Lingting_Gun)

        - `gcc --save-temps main.c -c `只对main.c做编译，不做链接 

        ![image-20200327170014274](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013327.png?Lingting_Gun)

        - 查看`main.i`的最后50行

        ![image-20200327170255743](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013333.png?Lingting_Gun)
...
- 左对齐
    ...
    ![image-20200327221910852](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013346.png?Lingting_Gun)

- 输出+

    ![image-20200327222425166](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013352.png?Lingting_Gun)

- 0填充

    ![image-20200327223525609](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013358.png?Lingting_Gun)
...
- `.number`
    ...
    ![image-20200327224215287](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013406.png?Lingting_Gun)

- `*` 和 `.*`

    ![image-20200327225442217](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013411.png?Lingting_Gun)
...
- hh
    ...
    ![image-20200327230242171](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013418.png?Lingting_Gun)
...
- n
    ...
    ![image-20200328012206429](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013424.png?Lingting_Gun)
...
- `*`
    ...
    ![image-20200328014243270](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013432.png?Lingting_Gun)
...
- `i`
    ...
    ![image-20200328014120732](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013439.png?Lingting_Gun)
...
- 输出的字符数（包括末尾的\n换行，也算一个字符）
    ...
    ![image-20200328015934837](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013446.png?Lingting_Gun)
...
- 运行test，读取数据，并将输出结果保存在12.out里面
    ...
    ![image-20200328145116532](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013456.png?Lingting_Gun)

- 打开12.out

    ![image-20200328145149826](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013506.png?Lingting_Gun)

- 将输入结果放在12.in里面

    ![image-20200328145339187](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013515.png?Lingting_Gun)

- 运行test，将文件12.in里面的内容输入，并得到输出结果

    ![image-20200328145432195](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013520.png?Lingting_Gun)

- 运行test，将文件12.in里面的内容输入，并将输出结果放在12.out里面

    ![image-20200328145614464](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013526.png?Lingting_Gun)
...
![image-20200328151259014](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013550.png?Lingting_Gun)

- 12.in里面存放的是12345
- 删除12.in

![image-20200328151422766](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013554.png?Lingting_Gun)
...
![image-20200328175707259](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013608.png?Lingting_Gun)

![image-20200328175615732](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013612.png?Lingting_Gun)
...
- 把一个int的若干为组合成一个结构
    ...
    ![image-20200328195509987](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013619.png?Lingting_Gun)
...
- 他们俩合起来可以实现`array_at`的功能
    ...
    ![image-20200328215754737](https://zmq20200506.oss-cn-shanghai.aliyuncs.com/images/20200507013628.png?Lingting_Gun)
